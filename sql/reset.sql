...
TRUNCATE TABLE examS4_simulation_paiement_modalite;
TRUNCATE TABLE examS4_paiement_modalite;
TRUNCATE TABLE examS4_status_pret;
TRUNCATE TABLE examS4_pret;
TRUNCATE TABLE examS4_simulation_pret;
TRUNCATE TABLE examS4_compte_client;
TRUNCATE TABLE examS4_client;
TRUNCATE TABLE examS4_tresorerie;
TRUNCATE TABLE examS4_config;
TRUNCATE TABLE examS4_modalite;
TRUNCATE TABLE examS4_type_pret;
TRUNCATE TABLE examS4_enum_status_pret;

-- Réinitialiser les auto_increment à 1 pour toutes les tables
ALTER TABLE examS4_enum_status_pret
    AUTO_INCREMENT = 1;
ALTER TABLE examS4_type_pret
    AUTO_INCREMENT = 1;
ALTER TABLE examS4_modalite
    AUTO_INCREMENT = 1;
ALTER TABLE examS4_client
    AUTO_INCREMENT = 1;
ALTER TABLE examS4_config
    AUTO_INCREMENT = 1;
ALTER TABLE examS4_tresorerie
    AUTO_INCREMENT = 1;
ALTER TABLE examS4_compte_client
    AUTO_INCREMENT = 1;
ALTER TABLE examS4_pret
    AUTO_INCREMENT = 1;
ALTER TABLE examS4_simulation_pret
    AUTO_INCREMENT = 1;
ALTER TABLE examS4_status_pret
    AUTO_INCREMENT = 1;
ALTER TABLE examS4_paiement_modalite
    AUTO_INCREMENT = 1;
ALTER TABLE examS4_simulation_paiement_modalite
    AUTO_INCREMENT = 1;
...
INSERT INTO examS4_config (libelle, date_application, valeur)
...
INSERT INTO examS4_tresorerie (date_mouvement, solde)
...
INSERT INTO examS4_simulation_pret (duree_remboursement, montant, date_demande, modalite_id, type_pret_id, taux_assurance,
                             assurance_par_mois)
...
INSERT INTO examS4_simulation_paiement_modalite (date_prevu_paiment, montant_prevu, mensualite, interet, amortissement,
...
SELECT 'examS4_enum_status_pret'                                                    as Table_Name,
       COUNT(*)                                                              as Records_Count,
       (SELECT AUTO_INCREMENT
        FROM information_schema.TABLES
        WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'examS4_enum_status_pret') as Next_Auto_Increment
FROM examS4_enum_status_pret
UNION ALL
SELECT 'examS4_type_pret'                                                    as Table_Name,
       COUNT(*)                                                       as Records_Count,
       (SELECT AUTO_INCREMENT
        FROM information_schema.TABLES
        WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'examS4_type_pret') as Next_Auto_Increment
FROM examS4_type_pret
UNION ALL
SELECT 'examS4_modalite'                                                    as Table_Name,
       COUNT(*)                                                      as Records_Count,
       (SELECT AUTO_INCREMENT
        FROM information_schema.TABLES
        WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'examS4_modalite') as Next_Auto_Increment
FROM examS4_modalite
UNION ALL
SELECT 'examS4_client'                                                    as Table_Name,
       COUNT(*)                                                    as Records_Count,
       (SELECT AUTO_INCREMENT
        FROM information_schema.TABLES
        WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'examS4_client') as Next_Auto_Increment
FROM examS4_client
UNION ALL
SELECT 'examS4_simulation_pret'                                                    as Table_Name,
       COUNT(*)                                                             as Records_Count,
       (SELECT AUTO_INCREMENT
        FROM information_schema.TABLES
        WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'examS4_simulation_pret') as Next_Auto_Increment
FROM examS4_simulation_pret
UNION ALL
SELECT 'examS4_simulation_paiement_modalite'                      as Table_Name,
       COUNT(*)                                            as Records_Count,
       (SELECT AUTO_INCREMENT
        FROM information_schema.TABLES
        WHERE TABLE_SCHEMA = DATABASE()
          AND TABLE_NAME = 'examS4_simulation_paiement_modalite') as Next_Auto_Increment
FROM examS4_simulation_paiement_modalite;